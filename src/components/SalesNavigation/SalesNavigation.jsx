  ...
  const getNavigationItems = () => {
    ...
    if (userRole === "SALES") {
      return [
        ...
        { id: "quotation", label: "Quotation", route: "/sales/quotations", section: "pre-sales" },
        { id: "inventory", label: "Inventory", route: "/sales/inventory", section: "pre-sales" },
        { id: "document", label: "Document", route: "/sales/documents", section: "pre-sales" },
        { id: "channel-partner", label: "Channel Partner Setup", route: "/channel-partner-setup", section: "pre-sales" },
